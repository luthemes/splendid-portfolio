 ...
 */
 ( function() {
	...
	screenreadertext.textContent = splendidPortfolioScreenReaderText.expandMain;
	...
	for ( i = 0, len = parentLink.length; i < len; i++ ) {
		...
		screenreadertext.classList.add( 'screen-reader-text' );
		screenreadertext.textContent = splendidPortfolioScreenReaderText.expandChild;
		...
		dropdown.onclick = function() {
			...
			if ( -1 !== parentLink.className.indexOf( 'toggled-on' ) ) {
				...
				screenreadertext.textContent = splendidPortfolioScreenReaderText.collapseChild;
			}
		};
	}
	...
	button.onclick = function() {
		...
		if ( -1 !== container.className.indexOf( 'toggled' ) ) {
			...
			screenreadertext.textContent = splendidPortfolioScreenReaderText.collapseMain;
